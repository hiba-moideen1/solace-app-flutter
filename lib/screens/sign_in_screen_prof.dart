import 'package:chatter/screens/home_screen_prof.dart';
...
class SignInScreenProf extends StatefulWidget {
  static Route get route => MaterialPageRoute(
    builder: (context) => const SignInScreen(),
  );
  const SignInScreenProf({Key? key}) : super(key: key);
  static const String id = 'signinprof';
  @override
  State<SignInScreenProf> createState() => _SignInScreenState();
}

class _SignInScreenState extends State<SignInScreenProf> {
