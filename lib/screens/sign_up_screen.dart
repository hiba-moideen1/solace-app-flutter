                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        Padding(
                          ...
                          child: CheckboxListTile(
                            title: const Text("Self Engagement Activities"),
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: CheckboxListTile(
                            title: const Text("Conversation with a mental health expert"),
                            contentPadding: EdgeInsets.zero,
                            value: conv,
                            activeColor: Theme.of(context).colorScheme.primary,
                            onChanged: (newValue) {
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            //  prefixIcon: const Icon(Icons.lock),
                            hintText: 'Enter your Care taker name',
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(10),
                            ),
                          ),
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            // prefixIcon: const Icon(Icons.lock),
                            hintText: 'Enter care taker mobile number',
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(10),
                            ),
                          ),
                          validator: (text) {
                            if (text == null || text.isEmpty) {
                              return 'Please enter care taker mobile number';
                            }
                            return null;
                          },
                        ),
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Reason for joining Solace'),
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: CheckboxListTile(
                          title: const Text("Eating disorder"),
                          contentPadding: EdgeInsets.zero,
                          value: ED,
                          activeColor: Theme.of(context).colorScheme.primary,
                          onChanged: (newValue) {
