...
import 'package:chatter/screens/consult_form.dart';
import 'package:chatter/screens/consultation.dart';
...
class HomeScreenProf extends StatelessWidget {
  static Route get route => MaterialPageRoute(
    builder: (context) => HomeScreenProf(),
  );
  HomeScreenProf({Key? key}) : super(key: key);
