...
class Email1 extends StatefulWidget {
  @override
  _Email1State createState() => _Email1State();
}
...
class _Email1State extends State<Email1> {
  ...
  final TextEditingController _bodyController = TextEditingController(text: "Dear Dr.Rihana, I am writing to schedule an appointment for you consultation. Please let me know when and where you would prefer to meet. I look forward to speaking to you in person. Thanks. ");
